...
/**
 * @author Crunchify.com How to iterate through Java List? Seven (7) ways to
 *         Iterate Through Loop in Java. 1. Simple For loop 2. Enhanced For loop
 *         3. Iterator 4. ListIterator 5. While loop 6. Iterable.forEach() util
 *         7. Stream.forEach() util
 */

public class SevenTypeOfIterateThroughList {
	...
	public static void main(String[] argv) {
		...
		if (crunchifyList.size() > 0) {
			...
			do {
				...
				j++;
			} while (j < crunchifyList.size());
		}

		// Iterable.forEach() util: Returns a sequential Stream with this collection as
		// its source
		...
		// collection Stream.forEach() util: Returns a sequential Stream with this
